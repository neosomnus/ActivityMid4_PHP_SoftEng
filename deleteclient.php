...
<body>
	...
	<div class="container" style="border-style: solid; height: 400px;">
		...
		<h2>Service Requested: <?php echo $getClientByID['service_requested'] ?></h2>
		<h2>Client Accountant: <?php echo $getClientByID['client_accountant'] ?></h2>
		<h2>Date Added: <?php echo $getClientByID['date_added'] ?></h2>

		<div class="deleteBtn" style="float: right; margin-right: 10px;">

			<form action="core/handleForms.php?client_id=<?php echo $_GET['client_id']; ?>&accountant_id=<?php echo $_GET['accountant_id']; ?>" method="POST">
